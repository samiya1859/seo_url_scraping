...
def fetch_urls(url):
    ...
    print(f"Anchor tags with valid 'http/https' URLs: {valid_http_anchor_urls} (After removing duplicates)")
    print(f"Total image tags found: {total_images}")
    print(f"Image tags with valid 'http/https' URLs: {valid_http_image_urls} (After removing duplicates)")
